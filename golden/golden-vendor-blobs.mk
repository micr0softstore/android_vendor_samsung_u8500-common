...
# Camera
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/hw/camera.montblanc.so:system/lib/hw/camera.vendor.montblanc.so \
...
# Audio
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/hw/audio.primary.DB8520H.so:system/lib/hw/audio.primary.DB8520H.so \
    $(LOCAL_PATH)/system/lib/hw/audio_policy.DB8520H.so:system/lib/hw/audio_policy.DB8520H.so \
    $(LOCAL_PATH)/system/lib/hw/audio.tms.default.so:system/lib/hw/audio.tms.default.so \
    $(LOCAL_PATH)/system/lib/lib_Samsung_Resampler.so:system/lib/lib_Samsung_Resampler.so \
    ...
    $(LOCAL_PATH)/system/lib/lib_Samsung_SB_AM_for_ICS_v03007.so:system/lib/lib_Samsung_SB_AM_for_ICS_v03007.so \
    ...
    $(LOCAL_PATH)/system/etc/Volume.db:system/etc/Volume.db
...
# Bluetooth
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/bin/bcm4334.hcd:system/bin/bcm4334.hcd
...
# GPS
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/lib/hw/gps.montblanc.so:system/lib/hw/gps.vendor.montblanc.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/lib/libalps_sensors_hal.so:system/lib/libalps_sensors_hal.so \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/lib/tee/8500bx_cops_ta_8500bx_secure.ssw:system/lib/tee/8500bx_cops_ta_8500bx_secure.ssw \
    $(LOCAL_PATH)/system/lib/tee/cops_ta:system/lib/tee/cops_ta \
...
# System STE Configs
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/system/etc/adm.sqlite-ab8505_v2:system/etc/adm.sqlite-ab8505_v2
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/system/lib/ste_omxcomponents/libst_omxredeye_detector.so:system/lib/ste_omxcomponents/libst_omxredeye_detector \
